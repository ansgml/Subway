...
class SaveEtcViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func savePressed(_ sender: UIBarButtonItem) {
        ...
        let entity = NSEntityDescription.entity(forEntityName: "EtcStations", in: context)
