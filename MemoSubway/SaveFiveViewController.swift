...
class SaveFiveViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func savePressed(_ sender: UIBarButtonItem) {
        ...
        let entity = NSEntityDescription.entity(forEntityName: "FiveStations", in: context)
