...
class SaveSixViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func savePressed(_ sender: UIBarButtonItem) {
        ...
        let entity = NSEntityDescription.entity(forEntityName: "SixStations", in: context)
