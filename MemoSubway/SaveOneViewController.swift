...
class SaveOneViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func savePressed(_ sender: UIBarButtonItem) {
        ...
        let entity = NSEntityDescription.entity(forEntityName: "Stations", in: context)
