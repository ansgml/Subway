//
//  RootFiveTableViewController.swift
//  MemoSubway
//
...
class RootFiveTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "FiveStations")
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toDetailFiveView" {
            if let destination = segue.destination as? DetailFiveViewController {
