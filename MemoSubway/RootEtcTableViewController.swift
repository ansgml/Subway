//
//  RootEtcTableViewController.swift
//  MemoSubway
//
...
class RootEtcTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "EtcStations")
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toDetailEtcView" {
            if let destination = segue.destination as? DetailEtcViewController {
