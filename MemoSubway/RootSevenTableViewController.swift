//
//  RootSevenTableViewController.swift
//  MemoSubway
//
...
import UIKit
import CoreData
class RootSevenTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "SevenStations")
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toDetailSevenView" {
            if let destination = segue.destination as? DetailSevenViewController {
