...
class SaveSevenViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func savePressed(_ sender: UIBarButtonItem) {
        ...
        let entity = NSEntityDescription.entity(forEntityName: "SevenStations", in: context)
