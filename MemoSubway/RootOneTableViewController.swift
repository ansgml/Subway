//
//  RootOneTableViewController.swift
//  MemoSubway
//
...
class RootOneTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "Stations")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let nameLabel = station.value(forKey: "stationname") as? String {
            display = nameLabel }
        if let placeLabel = station.value(forKey: "place") as? String {
            display = display + " (" + placeLabel + ")"
        }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toDetailOneView" {
            if let destination = segue.destination as? DetailOneViewController {
