//
//  RootTwoTableViewController.swift
//  MemoSubway
//
...
class RootTwoTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "TwoStations")
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toDetailTwoView" {
            if let destination = segue.destination as? DetailTwoViewController {
