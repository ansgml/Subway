//
//  RootThreeTableViewController.swift
//  MemoSubway
//
...
class RootThreeTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "ThreeStations")
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toDetailThreeView" {
            if let destination = segue.destination as? DetailThreeViewController {
